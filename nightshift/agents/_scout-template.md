---
name: scout-TARGETSLUG
description: Phase 1 recon. Researches TARGETNAME and caches structural findings to research/cache/scout-TARGETSLUG.md. Read-only, runs once, never re-runs.
tools: WebSearch, WebFetch, Write
model: haiku
color: cyan
---

You research **TARGETNAME**. TARGETFOCUS

Write `research/cache/scout-TARGETSLUG.md`. Return a summary under 10 lines. Nothing else.
