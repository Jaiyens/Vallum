...
export const DATASET_PAGE = {
  ...
  captureSpecs:
    "The capture kit is 4 to 6 refurbished iPhones on head straps, carried in personally. Every clip is head-mounted, 1080p minimum, 30fps.",
  ...
  offer:
    "A paid pilot licenses 20 to 40 curated, annotated, consent-cleared hours of this footage for $15,000 to $40,000: 50% on signature, 50% on delivery and acceptance. Licensing defaults to non-exclusive. Time-boxed, task-boxed exclusivity is available as a paid premium, scoped to one task and one window.",
